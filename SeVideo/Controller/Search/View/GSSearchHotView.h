...
@protocol GSDidTapsDelegate <NSObject>
 ...
 */
- (void)gs_selectTapsReturnValue:(NSArray *)valueArr groupId:(NSArray *)groupIdArr;
...
@interface GSSearchHotView : UIView

@property (weak,nonatomic) id <GSDidTapsDelegate>delegate;
